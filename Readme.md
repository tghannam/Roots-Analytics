...
# [Project 2: Predicting The Next Or Previous Perfect Squared Number Of A Specific Number X.]([Square_Number_Prediction.py](https://github.com/tghannam/ML/blob/main/Square_Number_Prediction.py))
